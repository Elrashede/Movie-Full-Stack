...
public class MovieFacade {
	...
	//public Object getMovieDetails(Integer id) {return movieDBService.getMovieDetails(id);}

//	public Object searchForMovie(String title) {return movieDBService.searchForMovie(title);}
